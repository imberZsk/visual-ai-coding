...
declare global {
  interface Window {
    api?: {
      ...
      listClaudeOutputStyles: (claudeHome: string) => Promise<ClaudeOutputStyleListResult>; // 扫描 Claude output style。
      ...
      checkClaudePluginUpdates: (claudeHome: string) => Promise<PluginUpdateCheckResult>; // 检查 Claude 插件更新。
      checkCodexPluginUpdates: (codexHome: string) => Promise<PluginUpdateCheckResult>; // 检查 Codex 插件更新。
