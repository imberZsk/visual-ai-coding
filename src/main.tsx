...
function RootProviders() {
  ...
  const themeMode = useAppStore((state) => state.prefs?.theme || getStartupThemePreference());
  ...
  // themeTokens 存储与项目 CSS 变量对齐的 Ant Design 主题 token。
  const themeTokens = {
    colorPrimary: "#1677ff",
    borderRadius: 6,
  ...
  return (
    <ConfigProvider locale={zhCN} theme={{ algorithm, token: themeTokens }}>
      <AntApp>
        <App />
      </AntApp>
    </ConfigProvider>
