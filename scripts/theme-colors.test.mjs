...
describe('theme colors', () => {
  ...
  it('keeps Ant Design light containers off pure white', () => {
    ...
    expect(normalizedEntrySource).toContain(
    ...
    expect(normalizedEntrySource).not.toContain(
      'colorBgContainer: isDark ? "#1c1c1b" : "#ffffff"'
    )
    expect(normalizedEntrySource).not.toContain(
      'colorBgElevated: isDark ? "#262624" : "#ffffff"'
    )
  })
})
